...
echo_and_run cd "/mnt/sbackup/Server_3/harshr/sbt_depth_experiments/husky_ws/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /mnt/sbackup/Server_3/harshr/sbt_depth_experiments/husky_ws/build/vision_opencv/image_geometry \
    build --build-base "/mnt/sbackup/Server_3/harshr/sbt_depth_experiments/husky_ws/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
